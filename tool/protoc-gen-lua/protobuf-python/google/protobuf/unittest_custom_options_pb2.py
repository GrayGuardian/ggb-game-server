...
_AGGREGATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='any', full_name='protobuf_unittest.Aggregate.any', index=5,
...
_AGGREGATE.fields_by_name['any'].message_type = google_dot_protobuf_dot_any__pb2._ANY
