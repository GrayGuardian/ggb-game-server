> 由于这个框架用了Koa框架去做底层，包括网络底层都是用插件，感觉太累赘了，所以打算重写一套不含插件的纯粹开源的架构，会合并到这个项目的分支里，目前这个主分支的框架项目还存在一些问题，该框架已在另一个手游项目开发中使用开源，修复了相关问题，可以前往项目[card-server](https://github.com/GrayGuardian/card-server)查看
